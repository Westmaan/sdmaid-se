...
class ThreemaFilter @Inject constructor(
    ...
    override suspend fun initialize() {
        ...
        val config = DynamicAppSieve2.MatchConfig(
            pkgNames = setOf(PKG_THREEMA.toPkgId()),
    ...
    override suspend fun match(
        ...
        // Optimization: Fail fast if the package is not Threema.
        // This prevents entering the heavy Sieve logic for 99% of scanned files.
        if (pkgId.name != PKG_THREEMA) return null
    ...
    companion object {
        ...
        private const val PKG_THREEMA = "ch.threema.app"
    }
}
